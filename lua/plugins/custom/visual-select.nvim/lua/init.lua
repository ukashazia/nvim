...
vim.api.nvim_create_autocmd({ "CursorMoved", "ModeChanged" }, {
  ...
  callback = function()
    ...
    for _, m in pairs(matches) do
      ...
      local m_starts_after_selection = m.start.line > selection_stop[2] or
          (m.start.line == selection_stop[2] and m.start.col > selection_stop[3])
      local m_ends_before_selection  = m.stop.line < selection_start[2] or
          (m.stop.line == selection_start[2] and m.stop.col < selection_start[3])
